 ...
 * 
 */
function addDomMarker(MapaZero) {
  ...
  var innerElement = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  ...
  pathElement.setAttribute('d', 'M8 16a6 6 0 0 0 6-6c0-1.655-1.122-2.904-2.432-4.362C10.254 4.176 8.75 2.503 8 0c0 0-6 5.686-6 10a6 6 0 0 0 6 6M6.646 4.646l.708.708c-.29.29-1.128 1.311-1.907 2.87l-.894-.448c.82-1.641 1.717-2.753 2.093-3.13');
  ...
  // MARCADORES
  var MarechalFlorianoPeixoto_1056 = new H.map.DomMarker({ lat: -26.82806, lng: -49.28573 }, {
    icon: DOM_Icon
  });
  MapaZero.addObject(MarechalFlorianoPeixoto_1056);

  var Esquina_Haiti_BarãoDoRioBranco = new H.map.DomMarker({ lat: -26.81929, lng: -49.26677 }, {
    icon: DOM_Icon
  });
...
var map = new H.Map(document.getElementById('mapa0'),
  defaultLayers.vector.normal.map, {
  center: { lat: -26.8210, lng: -49.2692 },
  zoom: 14,
